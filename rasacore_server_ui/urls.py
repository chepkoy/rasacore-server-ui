"""rasacore_server_ui URL Configuration
...
router.register(r'actions', rasacore_api.ActionsViewSet)

router.register(r'story-intents', rasacore_api.StoryIntentsViewSet)
